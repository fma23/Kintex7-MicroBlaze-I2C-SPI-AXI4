...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_GPIOs is
  signal \^fpga_led1\ : STD_LOGIC;
  signal \^fpga_led2\ : STD_LOGIC;
  signal LED1_Sig_i_1_n_0 : STD_LOGIC;
  signal LED1_Sig_i_2_n_0 : STD_LOGIC;
  signal LED1_Sig_i_3_n_0 : STD_LOGIC;
  signal LED1_Sig_i_4_n_0 : STD_LOGIC;
  signal LED1_Sig_i_5_n_0 : STD_LOGIC;
  signal LED1_Sig_i_6_n_0 : STD_LOGIC;
  signal LED1_Sig_i_7_n_0 : STD_LOGIC;
...
LED1_Sig_i_2: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
LED1_Sig_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFF7"
    )
        port map (
...
LED1_Sig_i_4: unisim.vcomponents.LUT4
    generic map(
      INIT => X"1000"
    )
        port map (
...
LED1_Sig_i_5: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
LED1_Sig_i_6: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFDF"
    )
        port map (
...
LED1_Sig_i_7: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFD"
    )
        port map (
