...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set FPGA_CLK_N [ create_bd_port -dir O -type clk FPGA_CLK_N ]
  set_property -dict [ list \
CONFIG.FREQ_HZ {10000000} \
 ] $FPGA_CLK_N
  set FPGA_CLK_P [ create_bd_port -dir O -type clk FPGA_CLK_P ]
  set_property -dict [ list \
CONFIG.FREQ_HZ {10000000} \
 ] $FPGA_CLK_P
  ...
  set UART_EN [ create_bd_port -dir O -from 0 -to 0 UART_EN ]
  set clk10mhz [ create_bd_port -dir I -type clk clk10mhz ]
  set_property -dict [ list \
CONFIG.FREQ_HZ {10000000} \
 ] $clk10mhz
  ...
  # Create instance: Adder_AXI4_IP_0, and set properties
  set Adder_AXI4_IP_0 [ create_bd_cell -type ip -vlnv dali.local:user:Adder_AXI4_IP:1.0 Adder_AXI4_IP_0 ]
...
CONFIG.NUM_SI {2} \
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M04_AXI [get_bd_intf_pins Adder_AXI4_IP_0/S00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M04_AXI]
  ...
  # Create port connections
  connect_bd_net -net Adder_AXI4_IP_0_FPGA_LED1 [get_bd_ports FPGA_LED1] [get_bd_pins Adder_AXI4_IP_0/FPGA_LED1]
  connect_bd_net -net Adder_AXI4_IP_0_FPGA_LED2 [get_bd_ports FPGA_LED2] [get_bd_pins Adder_AXI4_IP_0/FPGA_LED2]
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_ports UART_EN] [get_bd_pins axi_gpio_0/gpio2_io_o]
  ...
  connect_bd_net -net axi_uartlite_0_tx [get_bd_ports UARTTX] [get_bd_pins axi_uartlite_0/tx]
  connect_bd_net -net clk_in1_1 [get_bd_ports clk10mhz] [get_bd_pins Adder_AXI4_IP_0/Clk_10MHz_TXO] [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins clk_wiz_1/clk_in1]
  connect_bd_net -net clk_wiz_1_clk_out1 [get_bd_pins Adder_AXI4_IP_0/s00_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_axi_periph/S01_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk]
  connect_bd_net -net clk_wiz_1_clk_out2 [get_bd_ports FPGA_CLK_P] [get_bd_pins clk_wiz_1/clk_out2]
  connect_bd_net -net clk_wiz_1_clk_out3 [get_bd_ports FPGA_CLK_N] [get_bd_pins clk_wiz_1/clk_out3]
  connect_bd_net -net clk_wiz_1_locked [get_bd_pins clk_wiz_1/locked] [get_bd_pins rst_clk_wiz_1_100M/dcm_locked]
  connect_bd_net -net ext_reset_in_1 [get_bd_ports reset_n] [get_bd_pins Adder_AXI4_IP_0/Reset_n] [get_bd_pins clk_wiz_1/resetn] [get_bd_pins rst_clk_wiz_1_100M/ext_reset_in]
  ...
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins Adder_AXI4_IP_0/s00_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/M05_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins microblaze_0_axi_periph/S01_ARESETN] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn]
  connect_bd_net -net rx_1_1 [get_bd_ports UARTRX] [get_bd_pins axi_uartlite_0/rx]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x44A00000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs Adder_AXI4_IP_0/S00_AXI/S00_AXI_reg] SEG_Adder_AXI4_IP_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x44A00000 [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs Adder_AXI4_IP_0/S00_AXI/S00_AXI_reg] SEG_Adder_AXI4_IP_0_S00_AXI_reg
