#ifndef __Si5338Reg_H_
#define __Si5338Reg_H_


//Register map for use with AN428 (JumpStart)
//http://www.skyworksinc.com/timing
//#BEGIN_HEADER
//Date = Wednesday, January 26, 2022 12:58 PM
//File version = 3
...
//Part Number = Si533x
//#END_HEADER
//Input Frequency (MHz) = 80.000000000
//Input Type = LVDS_LVPECL_HCSL
//P1 = 2
//Input Mux = DivRefClk
//FDBK Input Frequency (MHz) = 80.000000000
//FDBK Input Type = OFF
//P2 = 1
//FDBK Mux = NoClk
//PFD Input Frequency (MHz) = 40.000000000
//VCO Frequency (GHz) = 2.560000
//N = 64  (64.0000)
//Internal feedback enabled
//Output Clock 0
// Output Frequency (MHz) = 80.000000000
// Mux Selection = IDn
// MultiSynth = 32  (32.0000)
// R = 1
//Output Clock 1
// Output Frequency (MHz) = 80.000000000
// Mux Selection = IDn
...
const Reg_Data RegData[NUM_REGS_MAX] =
{
	{  0,0x00,0x00},
	{  1,0x00,0x00},
	{  2,0x00,0x00},
